...
public:
  ...
  /* makeField
     ...
     makeField makes a field from the underlying controller using the index given by the user
  */
  ...
  */
  ...
  /* Parallel functions
     ...
     parallel_scan - a scan can be used to create a view where each value is the sum of the previous values.
  */
  
  template <typename FunctorType>
  void parallel_for(int lowerBound, int upperBound,
  ...
  void parallel_reduce(FunctorType &reductionKernel, ReducerType &reducer, std::string tag) {
