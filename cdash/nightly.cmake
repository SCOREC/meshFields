...
set(CTEST_DASHBOARD_ROOT "/users/d_zxg06726/nightlyBuilds/meshFields_build/" )
...
set(REPO_URL_BASE "https://github.com/SCOREC/meshFields")
set(BRANCH "main")
...
set_property(GLOBAL PROPERTY SubProject "meshfields")
set_property(GLOBAL PROPERTY Label "meshfields")
...
function(setup_repo)
  if(NOT EXISTS "${CTEST_SOURCE_DIRECTORY}/${CTEST_PROJECT_NAME}")
    ...
    # make local tracking versions of main branch
